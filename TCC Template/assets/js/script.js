...
function setList(list){
	var table = '<thead><tr><td>Descrição do Produto</td><td>Quantidade Selecionada</td><td>Valor</td><td>Ação</td></tr></thead><tbody>';
	for(var key in list){
...
function validation(){
	...
	if(desc === ""){
		errors += '<p>Descrição não Registrada</p>';
	}
	if(amount === ""){
		errors += '<p>Quantidade não Registrada</p>';
	}else if(amount != parseInt(amount)){
		errors += '<p>valor não enconctrado</p>';
	}
	if(value === ""){
		errors += '<p>Valor não registrado</p>';
	}else if(value != parseFloat(value)){
		errors += '<p>Coloque um valor Válido</p>';
	}
